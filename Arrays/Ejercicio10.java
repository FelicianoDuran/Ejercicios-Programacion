...
public class Ejercicio10 {
  public static void main(String[] args) {
    ...
    for (i = 0; i < 20; i++) {   //METEMOS LOS VALORES EN UN ARRAY INICIAL
    ...
    for (i = pares; i < 20; i++) {
      n[i] = impar[i - pares];  //mete los impares en las ultimas posiciones
    }

    System.out.println("Array con los pares al principio:");
    for (i = 0; i < 20; i++) {
      System.out.print(n[i] + " "); //Muestra el array con las posiciones intercambiadas
    }
  }
}
